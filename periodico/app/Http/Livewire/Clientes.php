...
class Clientes extends Component
{
    ...
    public function closeModalVentas()
    {
        $this->modalV = false;
    }
    ...
    {
        if ($this->ventaEncontrada != null && $this->clienteSeleccionado) {
