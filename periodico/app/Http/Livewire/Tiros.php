    ...
    public function render()
    {
        ...
        if ($this->from) {
            ...
            try {
                ...
                $this->rutaEncontrada = Ruta::where('id', $this->domsubs[0]['ruta'])->get();
            } catch (\Exception $e) {
                /* if ($e->getMessage()) {
                    $this->status = 'created';
