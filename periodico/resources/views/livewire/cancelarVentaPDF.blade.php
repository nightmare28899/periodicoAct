                        ...
                        <td>
                            <div class="form-group">
                                <label class="text-black" for="Física"> Fecha: De:
                                    {{ \Carbon\Carbon::parse($result->fechaInicio)->format('d/m/Y') }}, Hasta:
                                    {{ \Carbon\Carbon::parse($result->fechaFin)->format('d/m/Y') }} Tipo: Suscripcion
                                </label>
                            </div>
                        </td>
    ...
    @elseif ($tipo == 'ventas')
        @foreach ($ventas as $result)
            ...
            <table style="text-transform: uppercase;">
                ...
                <tbody class="centrado">
                    <tr>
                        <td>{{ $result->entregar }}</td>
                        <td>
                            <div class="form-group">
                                <label class="text-black" for="Física"> Fecha: De:
                                    {{ \Carbon\Carbon::parse($result->desde)->format('d/m/Y') }}, Hasta:
                                    {{ \Carbon\Carbon::parse($result->hasta)->format('d/m/Y') }} Tipo: Venta/cliente
                                </label>
                            </div>
                        </td>
