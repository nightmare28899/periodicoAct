<div class="relative">
    ...
    <div class="w-2/3">
        <input type="text"
            ...
            name="search" id="search" placeholder="Buscar Cliente" wire:model="query" wire:keydown.escape="resetear"
            wire:keydown.tab="resetear" wire:keydown.arrow-up="decrementHighlight"
        ...
        <div class="flex mt-2 space-x-4">
            <div class="px-2">
                <b>R.F.C.: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['rfc_input'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
        ...
        <div class="flex mt-2 space-x-4">
            <div class="px-2">
                <b>Razón Social: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['razon_social'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
            ...
            <div class="px-2">
                <b>Clasificación: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['clasificacion'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
        </div>
        <div class="flex mt-2 space-x-4">
            <div class="px-2">
                <b>Regimen Fiscal: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['regimen_fiscal'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
                <b>Telefono: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['telefono'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
                <b>País: <br> <input type="text" style="height: 1.7rem;" value="{{ $clienteSeleccionado['pais'] }}"
        ...
        <div class="flex mt-2 space-x-4">
            <div class="px-2">
                <b>Colonia: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['colonia'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
                <b>C.P.: <br> <input type="text" style="height: 1.7rem;" value="{{ $clienteSeleccionado['cp'] }}"
                        class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
                <b>localidad.: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['localidad'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
        </div>
        <div class="flex mt-2 space-x-4">
            <div class="px-2">
                <b>Municipio: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['municipio'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
            <div class="px-2">
                <b>Referencia: <br> <input type="text" style="height: 1.7rem;"
                        value="{{ $clienteSeleccionado['referencia'] }}" class="border-0 bg-gray-200" disabled></b>
            </div>
        </div>
    @else
        <div></div>
    ...
    <div class="flex">
        <div class="w-1/2 p-2">
            <label for="miércoles" class="block text-black text-sm font-bold mb-2">Miércoles(Opcional):</label>
            <input type="number" min="0"
