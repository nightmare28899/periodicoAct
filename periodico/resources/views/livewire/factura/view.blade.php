    ...
    <div class="py-12">
        <div class="mx-auto">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <div>
                    ...
                    <div class="flex mt-1">
                        ...
                        <div class="w-1/2 px-2">
                            ...
                            @if (substr($idTipo, 0, 6) == 'suscri')
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($suscripcion->importe, 2)) }}" disabled>
                            @else
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($tiro->importe, 2)) }}" disabled>
                            @endif
                        </div>
                    </div>
                    <div class="flex mt-1">
                    ...
                    <div class="flex mt-1">
                        ...
                        <div class="w-1/2 px-2">
                            ...
                            @if (substr($idTipo, 0, 6) == 'suscri')
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($suscripcion->total, 2)) }}" disabled>
                            @else
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($tiro->importe, 2)) }}" disabled>
                            @endif
                ...
                <div class="flex">
                    <div class="flex-none mx-1" style="width: 78%;"></div>
                    <div class="flex-none mx-1">
                        {{-- <button wire:click="reenviar"
                            ...
                            <svg wire:loading wire:target="reenviar"
