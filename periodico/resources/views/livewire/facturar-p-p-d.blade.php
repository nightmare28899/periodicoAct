            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <div>
                    ...
                    <div class="flex mt-1.5">
                        ...
                        <div class="w-1/2 px-2">
                            <label for="cfdiUse">CFDI:</label>
                            <select name="cfdiUse" id="cfdiUse" wire:model="cfdiUse" class="input-generic-style"
                                wire:loading.attr="disabled" wire:target="facturar">
                                <option selected style="display: none">Elegir una opcion</option>
                    ...
                    <div class="flex mt-1">
                        ...
                        <div class="w-1/2 px-2">
                            ...
                            @if (substr($idTipo, 0, 6) == 'suscri')
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($suscripcion[0]['importe'], 2)) }}" disabled>
                            @else
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($tiro[0]['importe'], 2)) }}" disabled>
                            @endif
                        </div>
                    </div>
                    <div class="flex mt-1">
                    ...
                    <div class="flex mt-1">
                        ...
                        <div class="w-1/2 px-2">
                            ...
                            @if (substr($idTipo, 0, 6) == 'suscri')
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($suscripcion[0]['total'], 2)) }}" disabled>
                            @else
                                <input type="text" class="border-0 bg-gray-200"
                                    value="{{ sprintf('$ %s', number_format($tiro[0]['importe'], 2)) }}" disabled>
                            @endif
