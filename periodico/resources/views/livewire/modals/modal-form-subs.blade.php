    ...
    <x-slot name="title">
        <div class="flex sm:px-6">
            ...
            <button type="button" wire:click="$set('modalFormDom', false)" wire:loading.attr="disabled"
                class="mb-3 text-gray-400 bg-transparent hover:bg-red-200 hover:text-blue-500 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-red-600 dark:hover:text-white"
