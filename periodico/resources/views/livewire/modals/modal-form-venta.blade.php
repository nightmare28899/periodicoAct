                ...
                <div class="flex w-full mt-2 space-x-4">
                    <div class="px-2 w-full">
                        <b>R.F.C.: <br> <input type="text" style="height: 1.7rem;"
                                               ...
                                               class="border-0 bg-gray-200 w-full"
                                               disabled></b>
                    </div>
                    <div class="px-2 w-full">
                        <b>Nombre: <br> <input type="text" style="height: 1.7rem;"
                                               value="{{ $clienteSeleccionado['nombre'] }}" class="border-0 bg-gray-200 w-full"
                                               disabled></b>
                    </div>
                </div>
                <div class="flex w-full mt-2 space-x-4">
                    ...
                    <div class="px-2 w-full">
                        <b>Estado: <br> <input type="text" style="height: 1.7rem;"
                                               value="{{ $clienteSeleccionado['estado'] }}" class="border-0 bg-gray-200 w-full"
                                               disabled></b>
                    </div>
                </div>
                <div class="flex w-full mt-2 space-x-4">
                ...
                <div class="flex w-full mt-2 space-x-4">
                    <div class="px-2 w-full">
                        <b>E-mail: <br> <input type="text" style="height: 1.7rem;"
                                               value="{{ $clienteSeleccionado['email'] }}" class="border-0 bg-gray-200 w-full"
                                               disabled></b>
                    </div>
                    <div class="px-2 w-full">
                ...
                <div class="flex w-full mt-2 space-x-4">
                    <div class="px-2 w-full">
                        <b>País: <br> <input type="text" style="height: 1.7rem;"
                                             value="{{ $clienteSeleccionado['pais'] }}" class="border-0 bg-gray-200 w-full"
                                             disabled></b>
                    </div>
                    <div class="px-2 w-full">
                    </div>
        ...
        <div class="flex px-4 sm:px-6 mt-5 space-x-4">
            <div class="w-1/2">
                <x-jet-secondary-button wire:click.prevent="abrirModalDomicilio" type="button"
                    ...
                    <svg wire:loading wire:target="abrirModalDomicilio" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
