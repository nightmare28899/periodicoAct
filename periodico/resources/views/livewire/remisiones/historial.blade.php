<div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @if ($result)
                <div class="text-center overflow-x">
                    ...
                    <br>
                    {{ $result->links('livewire.custom-pagination') }}
                </div>
            @else
    ...
    <x-jet-dialog-modal maxWidth="3xl" wire:model="modalEditar">
        ...
        <x-slot name="content">
            <div class="mb-3">
                <label for="devuelto" class="block text-black text-sm font-bold mb-2">Cantidad de
                    devueltos:</label>
                <input type="number"
