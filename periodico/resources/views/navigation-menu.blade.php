                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content" class="w-full text-center">
                            ...
                            <a href="{{ url('historialR' . '/normal') }}"><button class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition">{{ __('Historial Remisiones') }}</button></a>
                            ...
                            <a href="{{ url('historialR' . '/editar') }}"><button class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition">{{ __('Editar Domicilios de Suscripciones Activas') }}</button></a>
                            <a href="{{ url('agregarDiasSuscripcion') }}"><button class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition">{{ __('Agregar días al contrato') }}</button></a>
