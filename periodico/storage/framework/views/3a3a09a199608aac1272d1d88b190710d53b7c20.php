    ...
    <?php if($tipo == 'suscripciones'): ?>
        <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="logoCentrado">
                <img src="img/cancelado.png" width="260" height="260" alt="logo">
            </div>
            <table style="text-transform: uppercase;">
                ...
                <tbody class="centrado">
                    <tr>
                        <td><?php echo e($result['cantEjemplares']); ?></td>
                        <td>
                            <div class="form-group">
                                <label class="text-black" for="Física"> Fecha: De:
                                    <?php echo e(\Carbon\Carbon::parse($result->fechaInicio)->format('d/m/Y')); ?>, Hasta:
                                    <?php echo e(\Carbon\Carbon::parse($result->fechaFin)->format('d/m/Y')); ?> Tipo: Suscripcion
                                </label>
                            </div>
                        </td>
                        <?php $valUnitario = $result['total'] / $result['cantEjemplares']; ?>
                        <td><?php echo e(sprintf('$ %s', number_format($valUnitario, 2))); ?>

                        </td>
                        <td><?php echo e(sprintf('$ %s', number_format($result['total'], 2))); ?>
            ...
            <table style="text-transform: uppercase;">
                <tbody class="centrado">
                    <tr>
                        ...
                        <td></td>
                        <td>IMPORTE</td>
                        <td><?php echo e(sprintf('$ %s', number_format($result['total'], 2))); ?></td>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <thead>
                    <tr style="text-transform: uppercase; background-color: rgb(187, 230, 238);">
                        ...
                        <th class='px-4 py-2' style="width: 266px; font-size: 14px;"><?php echo e($result['cantEjemplares']); ?>

                        </th>
                        <th class='px-4 py-2' style="width: 140px; font-size: 14px;">neto</th>
                        <th class='px-4 py-2' style="width: 140px; font-size: 14px;">
                             <?php echo e(sprintf('$ %s', number_format($result['total'], 2))); ?>
    ...
    <?php elseif($tipo == 'ventas'): ?>
        <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table style="text-transform: uppercase;">
                ...
                <tbody class="centrado">
                    <tr>
                        <td><?php echo e($result->entregar); ?></td>
                        <td>
                            <div class="form-group">
                                <label class="text-black" for="Física"> Fecha: De:
                                    <?php echo e(\Carbon\Carbon::parse($result->desde)->format('d/m/Y')); ?>, Hasta:
                                    <?php echo e(\Carbon\Carbon::parse($result->hasta)->format('d/m/Y')); ?> Tipo: Venta/cliente
                                </label>
                            </div>
                        </td>
                        <td><?php echo e(sprintf('$ %s', number_format($result->ordinario, 2))); ?></td>
                        <td><?php echo e(sprintf('$ %s', number_format($result->entregar * $result->ordinario, 2))); ?>
            ...
            <table style="text-transform: uppercase;">
                <tbody class="centrado">
                    <tr>
                        ...
                        <td></td>
                        <td>IMPORTE</td>
                        <td><?php echo e(sprintf('$ %s', number_format($result->entregar * $result->ordinario, 2))); ?></td>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <thead>
                    <tr style="text-transform: uppercase; background-color: rgb(187, 230, 238);">
                        ...
                        <th class='px-4 py-2' style="width: 266px; font-size: 14px;">
                            <?php echo e($result->entregar); ?>

                        </th>
                        <th class='px-4 py-2' style="width: 140px; font-size: 14px;">neto</th>
                        <th class='px-4 py-2' style="width: 140px; font-size: 14px;">
                            <?php echo e(sprintf('$ %s', number_format($result->entregar * $result->ordinario, 2))); ?>
...
<?php /**PATH C:\Users\Nightmare28899\Documents\GitHub\periodicoAct\periodico\resources\views/livewire/cancelarVentaPDF.blade.php ENDPATH**/ ?>