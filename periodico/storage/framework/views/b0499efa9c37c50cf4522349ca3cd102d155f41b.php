...
<?php endif; ?>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['class' => 'text-gray-700 hover:text-gray-400','href' => ''.e(route('dashboard')).'','active' => request()->routeIs('dashboard')]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-gray-700 hover:text-gray-400','href' => ''.e(route('dashboard')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard'))]); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         ...
                         <?php $__env->slot('content', null, ['class' => 'w-full text-center']); ?> 
                            <a href="<?php echo e(url('cliente')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Cliente')); ?></button></a>
                            <a href="<?php echo e(url('ruta')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Ruta')); ?></button></a>
                            <a href="<?php echo e(url('tarifa')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Tarifa')); ?></button></a>
                            <a href="<?php echo e(url('tiro')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Tiro')); ?></button></a>
                            <a href="<?php echo e(url('remisiones')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Generar Remisión')); ?></button></a>
                            <a href="<?php echo e(url('historialR' . '/normal')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Historial Remisiones')); ?></button></a>
                            <a href="<?php echo e(url('Facturas')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Facturas')); ?></button></a>
                            <a href="<?php echo e(url('historialF')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Historial Facturas')); ?></button></a>
                            <a href="<?php echo e(url('historialR' . '/editar')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Editar Domicilios de Suscripciones Activas')); ?></button></a>
                            <a href="<?php echo e(url('agregarDiasSuscripcion')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Agregar días al contrato')); ?></button></a>
                            <a href="<?php echo e(url('suspenderSuscripcion')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Suspención de suscripción')); ?></button></a>
                            <a href="<?php echo e(url('FacturasPPD')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Factura PPD')); ?></button></a>
                            <a href="<?php echo e(url('complementoPago')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Complemento de pago')); ?></button></a>
                            <a href="<?php echo e(url('historialComplementoPago')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Historial complemento de pago')); ?></button></a>
                            <a href="<?php echo e(url('CancelarVenta' . '/venta')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Cancelar Ventas')); ?></button></a>
                            <a href="<?php echo e(url('CancelarSuscripciones' . '/suscri')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Cancelar Suscripciones')); ?></button></a>
                         <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         ...
                         <?php $__env->slot('content', null, ['class' => 'w-full text-center']); ?> 
                            <a href="<?php echo e(url('reporte-relacionCR')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Reporte relación de clientes por ruta')); ?></button></a>
                            <a href="<?php echo e(url('reporteSuscripcionSuspendida')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Reporte Suscripciones Suspendidas')); ?></button></a>
                            <a href="<?php echo e(url('reporteSuscripcionVencimiento')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Reporte Suscripciones Vencimiento')); ?></button></a>
                            <a href="<?php echo e(url('historialSuscripciones')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Historial Suscripciones')); ?></button></a>
                            <a href="<?php echo e(url('reportVentaPFacturas')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Reporte facturas')); ?></button></a>
                            <a href="<?php echo e(url('reporteSaldos')); ?>"><button
                                    class="btn px-2 w-full py-1 cursor-pointer text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition"><?php echo e(__('Reporte saldos')); ?></button></a>
                         <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php /**PATH C:\Users\Nightmare28899\Documents\GitHub\periodicoAct\periodico\resources\views/navigation-menu.blade.php ENDPATH**/ ?>